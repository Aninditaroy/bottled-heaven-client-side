            ...
            <div className="flex flex-col items-center  rounded-lg border shadow-md md:flex-row md:max-w-xl bg-gray-100 sm:w-22 sm:px-5">
                ...
                <div className="flex flex-col justify-between leading-normal my-12 mx-2">
                    ...
                    <div className='flex justify-center items-center'>
                        ...
                        <button onClick={handleUpdateQuantity} type="button" className="text-white bg-black flex mx-auto hover:bg-white hover:text-black border mr-14 hover:border-black rounded-lg text-sm px-3 py-2  text-center mb-1  mt-5 font-bold">Update Quantity</button>
                    </div>
                    <br />
