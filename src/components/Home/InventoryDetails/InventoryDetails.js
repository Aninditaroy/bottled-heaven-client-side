            ...
            <div class="flex flex-col items-center  rounded-lg border shadow-md md:flex-row md:max-w-xl bg-gray-100 ">
                ...
                <div class="flex flex-col justify-between leading-normal my-12">
                    ...
                    <div className='flex justify-center items-center'>
                        <input type="text" id="visitors" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-black focus:border-black block w-40 h-10 px-3 py-4 mt-4 font-bold " placeholder="Qty" required/>
                        <button type="button" className="text-white bg-black flex mx-auto hover:bg-white hover:text-black border mr-14 hover:border-black rounded-lg text-sm px-3 py-2  text-center mb-2  mt-5 font-bold">Update Quantity</button>
                    </div>
                    <br />
                    <small className="text-blue-400 text-sm mb-2">Supplier: {inventoryDetails.supplier_name}</small>
                    <button type="button" className="w-72 block text-white bg-black hover:bg-white hover:text-black border  hover:border-black rounded-lg text-sm py-2 mr-16 text-center mb-2  mt-3 font-bold">Delivered</button>
                </div>
            </div>
        </div>
    );
